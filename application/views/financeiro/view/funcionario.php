...
<?
	#Define Títulos Topo
	$tituloBase = "Fechamento de Funcionário";
	$subTitulo = "Pesquisar"; 
?>
    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content">
		    	<form class="form-inline" method="get" action="<?php echo base_url('financeiro/fechamentoFuncionario'); ?>">
                ...
                <fieldset>
						...
						<div class="line">
							...
							<input id="data_inicial" class="input-small" name="data_inicial" value="" type="date" required="required" style="width: 150px;">
			
            				<label class="control-label">Data Final</label>
							<input id="data_final" class="input-small" name="data_final" value="" type="date" required="required" style="width: 150px;">				
