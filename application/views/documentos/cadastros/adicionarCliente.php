...
<?
	#Define Títulos Topo
	if($this->router->method=="clienteEditar")
	{
		$tituloBase = "Editar Documentação de Cliente";
	} 
	else
	{
		$tituloBase = "Cadastro de Documentação para Clientes"; 
	}
?>
            ...
            <div class="widget-content" style="height: 300px">
                ...
                <fieldset>
						...
						<div class="line">
							<p>
							  ...
							  <select class="input-xxlarge" name="idAdministrador" id="idAdministrador" style="width: 715px !important;" autofocus>
							    ...
							    <option value="<? echo $listaCliente->idCliente; ?>" <? if(isset($result[0]->idAdministrador)){ if($listaCliente->idCliente==$result[0]->idAdministrador){ echo "selected"; } } ?>><? echo $listaCliente->razaosocial; ?></option>
							    <? } ?>
						      </select>
							  <br>
						  </p>
					...
					<div class="button-form line">										    
                        ...
                        <? } ?>
                        <a href="<?php echo base_url() ?>documentos/cliente" class="btn"><i class="icon-arrow-left"></i> Voltar</a>
                        </div>
				    </div>
		    	</fieldset>
	    	</form>
