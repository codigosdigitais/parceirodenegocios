<?php if($this->permission->canInsert()){ ?>
    <a href="<?php echo base_url();?>documentos/cedenteAdicionar" class="btn btn-success"><i class="icon-plus icon-white"></i> Adicionar Documento</a>    
<?php } ?>
    ...
    <tbody>
        <?php foreach ($results as $r) {
            ...
            if($this->permission->canUpdate()){
                echo '<a href="'.base_url().'documentos/cedenteEditar/'.$r->idDocumento.'" style="margin-right: 1%" class="btn btn-info " title="Editar Documento"><i class="icon-pencil icon-white"></i></a>'; 
            }
