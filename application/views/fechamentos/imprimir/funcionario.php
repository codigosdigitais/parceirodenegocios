...
<div class="widget-box" style="margin-top: -15px;">
     <div class="widget-title">
        ...
        <h5><? echo $results[0]->nome_funcionario;?></h5>
            <div class="buttons">
...
<div class="widget-content nopadding">
        <div class="span10" style="padding: 10px;">
            ...
            <div class="span2">
                <label for="">Total Chamadas</label>
                <button class="btn btn-inverse span12"> Valor: <? echo number_format($total_total_funcionario, 2, ',', '.'); ?> </button>
            </div>
...
<table class="table table-bordered ">
    <thead>
        <tr>
            <td style="text-align:center; background-color: #666; color: #FFF" colspan="8">CHAMADAS VINCULADAS ESTE FUNCIONÁRIO</td>
        </tr>    
        <tr>
        ...
        <?php
			foreach ($results as $r) {
				echo '<tr>';
					...
					echo '<td>'.substr($r->nome_empresa, 0, 35).'</td>';
...
<table class="table table-bordered ">
    <thead>
        <tr>
            <td style="text-align:center; background-color: #666; color: #FFF" colspan="4">ADICIONAIS VINCULADOS A ESTE FUNCIONÁRIO</td>
        </tr>    
        <tr>
...
<table class="table table-bordered ">
    ...
    <tbody>
        ...
        <tr>
        	<?
				$total_fatura = ($total_total_funcionario + $total_credito) - $total_debito;
			?>	
            <th>R$ <? echo number_format($total_total_funcionario, 2, ',', '.'); ?></th>
...
<table class="table table-bordered">
    <thead>
        ...
        <tr>
            <td style="text-align:center; background-color: #000000; color: #FFF" colspan="5"><? echo $results[0]->nome_funcionario;?></td>
        </tr>
        <tr>
            <th>Data Inicial</th>
            <th>Data Final</th>
    ...
    <tbody>
		<tr>
            ...
            <td>R$ <? echo number_format($total_total_funcionario, 2, ',', '.'); ?></td>
        </tr>
    </tbody>
</table>
...
<table class="table table-bordered">
    ...
    <thead>
        <tr>
            <td style="text-align:center; background-color: #666; color: #FFF" colspan="8">CHAMADAS VINCULADAS A ESTE FUNCIONÁRIO</td>
        </tr>    
        ...
        <?php 
			foreach ($results as $r) {
				echo '<tr>';
					...
					echo '<td>'.$r->hora.'</td>';
					echo '<td>'.$r->hora_repasse.'</td>';
					echo '<td>'.substr($r->nome_empresa, 0, 15).'</td>';
					echo '<td>R$ '.number_format($r->valor_funcionario, 2, ",", ".").'</td>';
				echo '</tr>';
       		}		
        ?>
