            ...
            <div class="widget-content">
                    ...
                    <div class="span12" style="margin-bottom: 15px;">
                    	...
                    	<form action="<?php echo base_url()?>relatorios/listarContrato" method="post">
                            ...
                            <input type="hidden" id="campo[]" name="campo[]" value="dados_horarios">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align:left; background-color: #666; color: #FFF"; colspan="2"><strong><? echo $valor->cedente; ?></strong></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align:left; background-color: #CCC; color: #333"; colspan="2"><strong>CLIENTES ATIVOS</strong></td>
                        ...
                        <tr style="background-color: #DEDEDE">
                            ...
                            <td style="width: 75% !important; "><strong>Funcionários</strong></td>
                                        ...
                                        <td>
                                            	...
                                            	<table style="width: 100%">
                                                	...
                                                	<tr>
                                                        ...
                                                        <th style="width: 30%">Segunda à Sexta</th>

                                                        <th style="width: 30%">Sábados</th>
                                                	...
                                                	<tr>
                                                    	...
                                                    	<td><? echo $funcionario->nomeFuncionario; ?></td>

                                                        <td><? echo $funcionario->horaentrada; ?> às <? echo $funcionario->horasaida; ?> - <? echo $funcionario->horaentradatarde; ?> às <? echo $funcionario->horasaidatarde; ?></td>

                                                        <td>
														<? if($funcionario->horaentradamanhasabado==false and $funcionario->horasaidamanhasabado==false and $funcionario->horaentradasabado==false and $funcionario->horasaidasabado==false){
															echo "Não trabalha sábado";
														} else {
														?>															
														<? echo $funcionario->horaentradamanhasabado; ?> às <? echo $funcionario->horasaidamanhasabado; ?> - <? echo $funcionario->horaentradasabado; ?> às <? echo $funcionario->horasaidasabado; } ?></td>
                                                	...
                                                	<tr style="background-color: #FFF">
                                                    	...
                                                    	<td style=" text-align:right">Total de Funcionários</td>

                                                        <td><strong><? echo $i; ?></strong></td>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center"; colspan="2"><strong>Nenhum cliente ativo neste cedente.</strong></td>
                                        ...
                                        <td>
                                            	...
                                            	<table style="width: 100%">
                                                	...
                                                	<tr>
                                                        ...
                                                        <td><? echo $funcionario->horaentradamanhasabado; ?> às <? echo $funcionario->horasaidamanhasabado; ?> - <? echo $funcionario->horaentradasabado; ?> às <? echo $funcionario->horasaidasabado; ?></td>
                                                	...
                                                	<tr style="background-color: #FFF">
                                                    	...
                                                    	<td style=" text-align:right">Valor do Contrato</td>

                                                        <td><strong>R$ <? echo number_format($total_contrato, 2, ",", "."); ?></strong></td>
