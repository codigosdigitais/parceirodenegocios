                                            	...
                                            	<table style="width: 100%">
													...
													<?
                                                        ...
                                                        foreach($valor_ativo->funcionarios_ativos as $funcionario){
															...
															$total_funcionario += $funcionario->valorfunc;

                                                    ?>

                                                	<tr>

                                                    	<td style="width: 25%"><? echo $funcionario->nomeFuncionario; ?></td>
														<td style="width: 15%"><? echo $funcionario->kmempresa; ?></td>
                                                        <td style="width: 15%"><? echo $funcionario->kmfuncionario; ?></td>
                                                        <td style="width: 15%">R$ <? echo number_format($funcionario->valor, 2, ",", "."); ?></td>
														<td style="width: 15%">R$ <? echo number_format($funcionario->valorfunc, 2, ",", "."); ?></td>
													...
													<tr style="background-color: #EDEDED">
														...
														<td style="width: 15%"><strong>Km Emp</strong></td>
                                                        <td style="width: 15%"><strong>Km Func</strong></td>
                                                        <td style="width: 15%"><strong>Funcionário</strong></td>
														<td style="width: 15%"><strong>Empresa</strong></td>
                                                        <td style="width: 15%"><strong>Lucro</strong></td>
                                                    </tr>
                                                	...
                                                	<tr style="background-color: #FFF">
                                                        ...
                                                        <td style="width: 15%"><strong></strong></td>
                                                        <td style="width: 15%"><strong>R$ <? echo number_format($total_contrato, 2, ",", "."); ?></strong></td>
                                                        <td style="width: 15%"><strong>R$ <? echo number_format($total_funcionario, 2, ",", "."); ?></strong></td>
                                                         <td style="width: 15%"><strong>R$ <? echo number_format($total_contrato-$total_funcionario, 2, ",", "."); ?></strong></td>
