...
<body>
      ...
      <nav class="navbar top-navbar col-lg-12 col-12 p-0">
        <div class="container">
          <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="index.html"><img src="<?php echo base_url('assets/chamada'); ?>/assets/images/logo-light.svg" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="<?php echo base_url('assets/chamada'); ?>/assets/images/logo-mini.svg" alt="logo"/></a>
          </div>
            ...
            <ul class="navbar-nav navbar-nav-right">
              ...
              <li class="nav-item nav-profile dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                  <img src="<?php echo base_url('assets/chamada'); ?>/assets/images/faces/face28.jpg" alt="profile"/>
                </a>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="<?php echo base_url('assets/chamada'); ?>/assets/images/dashboard/people.svg" alt="people">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <ul class="icon-data-list">
                    <li>
                      <div class="d-flex">
                        <img src="<?php echo base_url('assets/chamada'); ?>/assets/images/faces/face1.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="<?php echo base_url('assets/chamada'); ?>/assets/images/faces/face2.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                      <img src="<?php echo base_url('assets/chamada'); ?>/assets/images/faces/face3.jpg" alt="user">
                     <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="<?php echo base_url('assets/chamada'); ?>/assets/images/faces/face4.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="<?php echo base_url('assets/chamada'); ?>/assets/images/faces/face5.jpg" alt="user">
                        <div>
  ...
  <!-- plugins:js -->
  <script src="<?php echo base_url('assets/chamada'); ?>/<?php echo base_url('assets/chamada'); ?>/assets/js/vendor.bundle.base.js"></script>
  <!-- endinject -->
