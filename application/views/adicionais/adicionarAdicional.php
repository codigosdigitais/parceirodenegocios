<script type="text/javascript" src="<?php echo base_url()?>assets/controllers/adicional/js/adicional.js"></script>
                ...
                <fieldset>
						...
						<div class="line">
							...
							<select class="input-xxlarge" name="idAdministrativo" id="idAdministrativo" style="width: 715px !important;" required>
                                ...
                                ?>
                                <option value="<?=$funcionarioLista->idFuncionario;?>" <? if(isset($result->idAdministrativo)){ if($funcionarioLista->idFuncionario==$result->idAdministrativo){ echo "selected"; } } ?> ><?=$funcionarioLista->nome;?></option>
                                <? } ?>								
							</select>
						</div>
					...
					<div class="button-form line">										    
                        ...
                        <? } ?>
                        <a href="<?php echo base_url() ?>adicionais" class="btn"><i class="icon-arrow-left"></i> Voltar</a>
                        </div>
				    </div>
		    	</fieldset>
	    	</form>
