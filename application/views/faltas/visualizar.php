<div class="widget-box">
    <div class="widget-title">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#tab1">Fatas deste Funcionário</a></li>
                                ...
                                <div class="collapse in accordion-body" id="collapseGOne">
                                    <div class="widget-content">
                                        ...
                                        <table class="table table-bordered ">
                                            ...
                                            <tbody>
												<?php foreach ($result[0]->listaFaltas as $r) {
                                                    ...
                                                    if($this->permission->canUpdate()){
                                                        echo '<a href="'.base_url().'proventos/editar/'.$r->idFalta.'" style="margin-right: 1%" class="btn btn-info " title="Editar Provento"><i class="icon-pencil icon-white"></i></a>'; 
                                                    }
                                                    if($this->permission->canDelete()){
                                                        echo '<a href="#modal-excluir" role="button" data-toggle="modal" Provento="'.$r->idFalta.'" style="margin-right: 1%" class="btn btn-danger " title="Excluir Provento"><i class="icon-remove icon-white"></i></a>'; 
                                                    }
