                                            ...
                                            <div class="span9">
                                                ...
                                                foreach($lista_funcionario as $key => $valor){
                                                    ...
                                                    <div class="span12" style="height:35px;">
                                                        ...
                                                        <div class="span6">
                                                            <input id="campo[<?php echo $key;?>][detalhes]" class="span10" type="text" name="campo[<?php echo $key;?>][detalhes]" placeholder="Detalhes do Desconto" value="<? if($this->input->post('detalhes')!=NULL){ echo $this->input->post('detalhes'); } ?>" />
                                                        </div>
                                                    </div>
                                                <?php
                                                } 
