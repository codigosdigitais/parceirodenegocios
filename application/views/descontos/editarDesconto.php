...
<?
	...
	{
		$tituloBase = "Editar Desconto";
	} 
	else
	{
		$tituloBase = "Cadastro de Desconto"; 
	}
?>
            ...
            <div class="widget-content">
				...
				<?php 
                    if($this->uri->segment(3)=="editar"){
                        echo form_hidden('idDesconto',$result->idDesconto);
						echo form_hidden('idFuncionario',$result->idFuncionario);
                    } 
                ?>

                <fieldset>
		    			<legend><i class="icon-plus icon-title"></i> Novo Desconto</legend>
						<div class="line">
							...
							<option value="">Selecione o Tipo de Desconto</option>
                                ...
                                <option value="<? echo $listaDesconto->idParametro; ?>" <? if(isset($result->tipo)){ if($listaDesconto->idParametro==$result->tipo){ echo "selected"; } } ?> disabled><? echo $listaDesconto->parametro; ?></option>
                                <? } ?>
							</select>
						</div>
