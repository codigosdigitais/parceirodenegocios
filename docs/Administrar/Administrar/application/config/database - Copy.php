...
$db['default']['hostname'] = 'localhost';//189.115.55.71
$db['default']['username'] = 'root'; // pixxdigi_entrega //codigo3_sistema
$db['default']['password'] = ''; // ]X!^om5m+WW^ //admin102030
$db['default']['database'] = 'codigo3_administrador';
...
$db['localhost']['database'] = 'codigo3_administrador';
