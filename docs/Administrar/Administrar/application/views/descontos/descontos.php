...
<?php if($this->permission->canInsert()){ ?>
    <a href="<?php echo base_url();?>descontos/lista" class="btn btn-success"><i class="icon-plus icon-white"></i> Listar Descontos Adicionados</a>    
<?php } ?>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content">
                    ...
                    <table class="table table-bordered ">
                        ...
                        <tbody>
                            <?php 
							foreach ($parametroDesconto as $r) {
                                echo '<tr>';
                                ...
                                if($this->permission->canInsert()){
                                    echo '<a href="'.base_url().'descontos/adicionar/'.$r->idParametro.'" style="margin-right: 1%" class="btn ">INCLUIR REGISTROS</a>'; 
                                }
                                echo '</td>';
                                echo '</tr>';
                            }
	...
	<script>
		...
		function getParametro() {
			...
			$.post("<? echo base_url(''); ?>descontos/ajax/parametro/" + id,
		...
		function getEmpresaRegistro() {
			...
			$.post("<? echo base_url(''); ?>descontos/ajax/empresaregistro/",
