<?php if($this->permission->canInsert()){ ?>
    <a href="<?php echo base_url();?>documentos/adicionarPropaganda" class="btn btn-success"><i class="icon-plus icon-white"></i> Adicionar Propaganda</a>
<?php } ?>
...
<!--            <th>Data</th>-->
    ...
    <tbody>
        <?php foreach ($results as $r) {
            echo '<tr>';
            echo '<td>';
            switch ($r->idAdministrador) {
                case 1: echo "Chamada Externa"; break;
                case 2: echo "Tela Inicial"; break;
            }
            echo '</td>';
...
//			echo '<td>'.date("d/m/Y", strtotime($r->data)).'</td>';
            ...
            if($this->permission->canUpdate()){
                echo '<a href="'.base_url().'documentos/propagandaEditar/'.$r->idDocumento.'" style="margin-right: 1%" class="btn btn-info " title="Editar Documento"><i class="icon-pencil icon-white"></i></a>';
            }
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <form action="<?php echo base_url() ?>documentos/propagandaExcluir" method="post" >
