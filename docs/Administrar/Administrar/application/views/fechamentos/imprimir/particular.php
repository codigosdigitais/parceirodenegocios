...
<div class="widget-content nopadding">
        <div class="span12" style="padding: 10px;">
            ...
            <div class="span2">
                ...
                <button class="btn btn-inverse span12" style="background-color: red"> Total: <? echo $results[0]->contagem->totalOs;?> </button>
            </div>
            
            <div class="span2">
                <label for="">Total Empresa</label>
                <button class="btn btn-inverse span12"> Valor: <? echo number_format($results[0]->contagem->valorEmpresa, 2, ',', '.'); ?> </button>
            </div>
            
            <div class="span2">
                <label for="">Total Funcionário</label>
                <button class="btn btn-inverse span12"> Valor: <? echo number_format($results[0]->contagem->valorFuncionario, 2, ',', '.'); ?> </button>
            </div>
...
<table class="table table-bordered ">
    <thead>
        <tr>
            ...
            <th style="width: 100px;">Valor Empresa</th>
            <th style="width: 100px;">Valor Funcionario</th>
            <th style="width: 40px;"></th>
        </tr>
    </thead>
    <tbody>
        <?php foreach ($results as $r) {
            echo '<tr>';
				...
				echo '<td>R$ '.number_format($r->valorFuncionario, 2, ",", ".").'</td>';
				echo '<td>';
				if($this->permission->controllerManual('financeiro/funcionario')->canSelect()){
                echo '<a href="'.base_url().'fechamentos/fechamentoParticular?idFuncionario='.$r->idFuncionario.'&data_inicial='.$_GET['data_inicial'].'&data_final='.$_GET['data_final'].'&view=todos" style="margin-right: 1%" class="btn " title="Visualizar Todas"><i class="icon-eye-open"></i></a>'; 
            	}
				echo '</td>';
            echo '</tr>';
        }
...
<div class="widget-content nopadding">
        <div class="span12" style="padding: 10px;">
            ...
            <div class="span2">
                <label for="">Total Funcionário</label>
                <button class="btn btn-inverse span12"> Valor: <? echo number_format($results[0]->valorFuncionario, 2, ',', '.'); ?> </button>
            </div>
 </div>
...
<table class="table table-bordered ">
    <thead>
        ...
        <tr>
            ...
            <th>Funcionário</th>
            <th style="width: 100px;">Valor Empresa</th>
            <th style="width: 100px;">Valor Funcionário</th>
            <th style="width: 40px;"></th>
        </tr>
    </thead>
    <tbody>
...
<table class="table table-bordered">
    ...
    <tbody>
		<tr>
            ...
            <td>R$ <? echo number_format($results[0]->valorFuncionario, 2, ',', '.'); ?></td>
        </tr>
    </tbody>
</table>
