            ...
            <div class="widget-content">
                    ...
                    <div class="span12" style="margin-bottom: 15px;">
                    	...
                    	<form action="<?php echo base_url()?>relatorios/listarCliente" method="post">
                            ...
                            <input type="hidden" id="campo[]" name="campo[]" value="dados_empresa">
                        ...
                        <tr style="background-color: #DEDEDE">
							...
							?>
                                    ...
                                    <tr> 
                                        ...
                                        <td><? echo $valor_ativo->cnpj; ?></td>

                                        <td><? echo $valor_ativo->ie; ?></td>

                                        <td><? echo $valor_ativo->im; ?></td>

                                        <td><? echo $valor_ativo->endereco; ?>, <? echo $valor_ativo->endereco_numero; ?> - <? echo $valor_ativo->endereco_cep; ?> - <? echo $valor_ativo->endereco_bairro; ?>, <? echo $valor_ativo->endereco_cidade; ?> - <? echo $valor_ativo->endereco_estado; ?></td>
                        ...
                        <tr style="background-color: #DEDEDE">
							...
							?>
                                    ...
                                    <tr> 
                                        ...
                                        <td><? echo $valor_inativo->cnpj; ?></td>

                                        <td><? echo $valor_inativo->ie; ?></td>

                                        <td><? echo $valor_inativo->im; ?></td>

                                        <td><? echo $valor_inativo->endereco; ?>, <? echo $valor_inativo->endereco_numero; ?> - <? echo $valor_inativo->endereco_cep; ?> - <? echo $valor_inativo->endereco_bairro; ?>, <? echo $valor_inativo->endereco_cidade; ?> - <? echo $valor_inativo->endereco_estado; ?></td>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center"; colspan="5"><strong>Nenhum cliente inativo neste cedente.</strong></td>
